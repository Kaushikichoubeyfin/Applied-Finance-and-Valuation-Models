...
│
├── Basic_Models/
│   ├── CF_Investment valuation_IRR_NPV.xlsx
│   ├── FM_Basic Financial Analysis.xlsm
│   └── placeholder.txt
│
├── Leasing_Problem/
│   └── placeholder.txt
...
##  Included Models
 **CF_Investment valuation_IRR_NPV.xlsx** — project appraisal with NPV, IRR, XNPV & XIRR using projected cash flows and sensitivity tables.  
 **FM_Basic Financial Analysis.xlsm** - Pension Problem, Retirement Plan
 **Leasing_Problem** — lease vs. buy evaluations and payment schedule comparisons.
